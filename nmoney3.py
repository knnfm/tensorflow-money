...
with open('sample.csv') as f:
    ...
    for row in reader:
        ...
        x3 = int(row[2])
        y1 = int(row[3])
        test_x = np.append(test_x, np.array([[x1, x2, x3]]), axis=0)
...
for i in range(100000):
    ...
    if (i + 1) % 10 == 0:
        print "step=%3d, a1=%6.2f, a2=%6.2f, a3=%6.2f, loss = %.2f" % (i + 1, a_[0], a_[1], a_[2], l)
...
# 4.新しいデータに対して予測する
# (1) 新しいデータを用意
new_x = np.array([2, 4, 3]).reshape(1, 3)
